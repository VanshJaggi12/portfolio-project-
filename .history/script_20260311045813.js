...
const initThreeJS = () => {
    ...
    // Expose material to window to update color on theme switch
...
// 4. Scroll Reveal & Counters & Skill Bars
...
function toggleTheme() {
    ...
    // Update ThreeJS Particle colors
...
// 9. Project Rendering & Filtering & Modal
const projectsData = [
    {
        id: 1, title: "AI Chatbot Interface", category: "web",
        img: "https://images.unsplash.com/photo-1531746790731-6c087fecd65a?w=800&q=80",
        desc: "An intelligent conversational interface integrated with AI APIs.",
        challenge: "Users needed a way to query documentation using natural language.",
        solution: "Built a React frontend with a Node.js proxy to securely handle API keys.",
    ...
    },
    {
        ...
        challenge: "Small businesses needed a high-performance store.",
        solution: "Developed a MERN stack app with Redux and Stripe API.",
        tech: ["MongoDB", "Express", "React", "Node.js"]
    },
    {
        id: 3, title: "Task Manager Suite", category: "app",
        img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80",
        desc: "Productivity tool with drag-and-drop kanban boards.",
        challenge: "Existing tools were too complex for personal use.",
        solution: "Utilized LocalStorage and Firebase for real-time syncing.",
...
function renderProjects(filter = 'all') {
    ...
    filtered.forEach(p => {
        ...
        card.className = 'project-card tilt-element reveal active'; // active to bypass scroll reveal when filtering
    ...
    init3DTilt(); // Re-bind tilt events for new cards
}
...
window.onload = () => {
    ...
    // Slight delay for terminal for better UX
