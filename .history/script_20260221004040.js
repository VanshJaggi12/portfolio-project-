...
// 2. Form Submission Alert (Contact Page)
...
// 4. Navigation with Sliding Pill
...
const words = ["Full Stack Developer", "BCA Student (2026)", "Python Enthusiast", "Problem Solver"];
...
const lines = [
    ...
    "> loading modules: [python, react, unity, node]...", "➜", 
    "> compiling smart_task_manager.py...", "➜", 
