...
const words = ["Backend Developer", "BCA Student", "AI Enthusiast"];
...
const lines = [
    ...
    "> loading modules: [python, fastapi, react]...", 
    "> connecting to github.com/VanshJaggi12...", 
    "> status: OPEN_TO_WORK",
...
const projectsData = [
    {
        id: 1, title: "AI Chatbot Web Application", category: "web",
        img: "https://images.unsplash.com/photo-1531746790731-6c087fecd65a?w=800&q=80",
        desc: "Developed an AI chatbot capable of handling 100+ real-time queries.",
        challenge: "Needed a system that could handle multiple sessions and contextual memory accurately.",
        solution: "Integrated Gemini API and optimized prompts to greatly improve response accuracy.",
    ...
    },
    {
        ...
        desc: "Built an expense tracking system to manage 100+ expense records.",
        challenge: "Users needed an intuitive GUI to log and visualize their monthly spending habits.",
        solution: "Developed a desktop app tracking expenses and generating visual reports automatically.",
        tech: ["Python", "Tkinter", "SQLite", "Matplotlib"]
    },
    {
        id: 3, title: "Personal Portfolio Website", category: "web",
        img: "https://images.unsplash.com/photo-1507238692062-5a0445d41fcc?w=800&q=80",
        desc: "Developed a responsive portfolio showcasing projects and repositories.",
